"""Final clean launch video - All-Rounder voice from Josh + Edwards dunk BG"""
...
OUT = r"C:\Users\joshs\.openclaw\workspace\parlayguarantee\tiktok-videos\pg_launch_CLEAN_FINAL.mp4"
...
# Timed to ~19s audio. Spacing out segments evenly.
seg = dur / 6  # ~3.2s per segment
...
print("Building final clean launch video...", flush=True)

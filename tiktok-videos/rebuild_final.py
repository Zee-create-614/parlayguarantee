"""Rebuild launch video with Christian J Jones (All-Rounder) voice + clean language"""
...
VOICE_ID = "kweHip4RLym5z4rldbvY"  # Christian J Jones - All-Rounder
...
print("Generating voiceover with All-Rounder (Christian J Jones)...", flush=True)
resp = requests.post(

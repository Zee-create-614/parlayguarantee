"""V7 - Music even louder. Voice 0.8, music 1.3"""
...
MIXED = r"C:\Users\joshs\.openclaw\workspace\parlayguarantee\tiktok-videos\mixed_v7.wav"
OUT = r"C:\Users\joshs\.openclaw\workspace\parlayguarantee\tiktok-videos\pg_launch_CLEAN_v7.mp4"
FONT = "C\\\\:/Windows/Fonts/impact.ttf"
dur = 19.7

r = subprocess.run([FFMPEG, "-y", "-i", NORM_VOICE, "-i", NORM_MUSIC,
    "-filter_complex",
    "[0:a]volume=0.8[v];[1:a]volume=1.3[m];[v][m]amerge=inputs=2,pan=stereo|c0<c0+c2|c1<c1+c3,alimiter=limit=0.95[out]",

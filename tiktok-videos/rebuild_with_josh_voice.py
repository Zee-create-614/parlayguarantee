"""Rebuild launch video using instant voice clone from 'Josh voice.mp3'"""
...
JOSH_VOICE_REF = r"C:\Users\joshs\Downloads\Josh voice.mp3"
...
VO_PATH = r"C:\Users\joshs\.openclaw\workspace\parlayguarantee\tiktok-videos\assets\vo_launch_clean_v2.mp3"

# Step 1: Create instant voice clone
print("Creating instant voice clone from 'Josh voice.mp3'...", flush=True)
with open(JOSH_VOICE_REF, "rb") as f:
    resp = requests.post(
        "https://api.elevenlabs.io/v1/voices/add",
        headers={"xi-api-key": ELEVEN_KEY},
        data={"name": "AllRounder-Clone", "description": "All-Rounder voice for ParlayGuarantee"},
        files={"files": ("josh_voice.mp3", f, "audio/mpeg")}
    )

if resp.status_code != 200:
    print(f"Clone error: {resp.status_code} {resp.text[:500]}")
    exit(1)
...
print("Generating voiceover...", flush=True)
resp = requests.post(
...
print("Building clean launch video with All-Rounder voice...", flush=True)

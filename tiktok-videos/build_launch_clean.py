"""Rebuild launch video - CLEAN TOS-compliant version
Same Edwards dunk BG, Brian voice, Impact bold green+white text
...
OUT = r"C:\Users\joshs\.openclaw\workspace\parlayguarantee\tiktok-videos\pg_launch_CLEAN.mp4"
FONT = "C\\\\:/Windows/Fonts/impact.ttf"
ELEVEN_KEY = "sk_3bd03ab4e8df0cb2609ff7d1c58b7167a108d24566c432c9"
BRIAN_VOICE = "nPczCjzI2devNBz1zQrb"
...
VO_PATH = r"C:\Users\joshs\.openclaw\workspace\parlayguarantee\tiktok-videos\assets\vo_launch_clean.mp3"

print("Generating clean voiceover via ElevenLabs...", flush=True)
resp = requests.post(
    f"https://api.elevenlabs.io/v1/text-to-speech/{BRIAN_VOICE}",
...
# Get audio duration
probe = subprocess.run([FFMPEG.replace("ffmpeg.exe","ffprobe.exe"), "-v","quiet","-show_entries","format=duration","-of","csv=p=0", VO_PATH], capture_output=True, text=True)
...
# CLEAN text overlays - NO gambling language
texts = []
...
print("Building clean launch video...", flush=True)

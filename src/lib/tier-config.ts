...
export const TIER_CONFIGS: Record<string, TierConfig> = {
  'single': {
    ...
    description: 'One AI-curated moneyline pick — auto-assigned from your sport.',
    guarantee: 'Loses? Full $5 refund.',
  },
  '2leg': {
    id: '2leg',
    name: '2-Leg Parlay',
    ...
    guarantee: 'Any leg loses? Full $10 refund.',
  },
  '3leg': {
    id: '3leg',
    name: '3-Leg Parlay',
    ...
    guarantee: 'Any leg loses? Full $20 refund.',
  },
  '4leg': {
    id: '4leg',
    name: '4-Leg Parlay',
    ...
    guarantee: 'Any leg loses? Full $35 refund.',
  },
  '5leg': {
    id: '5leg',
    name: '5-Leg Parlay',
    ...
    guarantee: 'Any leg loses? Full $50 refund.',
  },
  '6leg': {
    id: '6leg',
    name: '6-Leg Parlay',
    ...
    guarantee: 'Any leg loses? Full $75 refund.',
  },
  '7leg': {
    id: '7leg',
    name: '7-Leg Parlay',
    ...
    guarantee: 'Any leg loses? Full $100 refund.',
  },
}
...
export const ML_TIER_CONFIGS: Record<string, TierConfig> = {
  ...
  'ml-2leg': {
    ...
    guarantee: 'Any leg loses? Full $12 refund.',
  },
  'ml-3leg': {
    id: 'ml-3leg',
    ...
    guarantee: 'Any leg loses? Full $25 refund.',
  },
  'ml-4leg': {
    id: 'ml-4leg',
    ...
    guarantee: 'Any leg loses? Full $45 refund.',
  },
  'ml-5leg': {
    id: 'ml-5leg',
    ...
    guarantee: 'Any leg loses? Full $65 refund.',
  },
}
